...
export function SaltedFishPet() {
    ...
    return (_jsxs(_Fragment, { children: [_jsx("button", { ref: recallBtnRef, className: css.recallInline, onClick: () => setPetHidden(!hidden), title: hidden ? '显示咸鱼' : '隐藏咸鱼', children: hidden ? '显示咸鱼' : '隐藏咸鱼' }), !hidden && (_jsx("div", { ref: petRef, className: `${css.pet} ${isDragging ? css.dragging : ''}`, style: pos === null
                    ? undefined
